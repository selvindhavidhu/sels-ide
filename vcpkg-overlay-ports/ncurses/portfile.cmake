...
# --enable-mixed-case forces ncurses to look up terminfo entries under
# single-letter directories (e.g. "x/xterm"). That only matches
# case-preserving, case-sensitive filesystems. macOS's default APFS/HFS+
# volumes are case-insensitive, so both Apple's system terminfo database and
# Homebrew's ncurses use hex-encoded leaf directories instead (e.g.
# "78/xterm-256color"). Forcing --enable-mixed-case there makes every
# terminfo lookup fail (newterm()/setupterm() always return an error),
# regardless of TERM or TERMINFO. Leave it unset on macOS so configure's own
# runtime case-sensitivity probe picks the convention that actually matches
# the system database.
if(NOT VCPKG_TARGET_IS_MINGW AND NOT VCPKG_TARGET_IS_OSX)
    list(APPEND OPTIONS
        --enable-mixed-case
    )
endif()
